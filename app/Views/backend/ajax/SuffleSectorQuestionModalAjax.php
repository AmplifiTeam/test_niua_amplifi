...
<p class="fnt-sz">Shuffle Questions</p>
<p class="fnt-subhead">
<!-- Sector Name = -->          
</p>
</div>
...
<div class="modal-body" id="questionListToBeSuffledHere">
<div class="accordion accordion-flush" id="accordionFlushExampleSuffle">
<?php foreach($questionList as $key=>$question){?>
<div class="accordion-item card-body1 pad-3 getSuffleIdexForSectorQuestions" data-QB_ID="<?=$question['QB_ID']?>" data-Sector_ID="<?=$Sector_ID?>">
<i class="bi bi-arrow-down-up"></i>
<h2 class="accordion-header d-flex align-items-center" style="margin-left:20px;">
<button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapse<?=$key+1?>00" aria-expanded="false" aria-controls="flush-collapse<?=$question['QB_ID']?>">
<span class="updateSequence"><?=$key+1?></span>.&nbsp;&nbsp;<span class=""><?=$question['Description']?></span>   &nbsp;
</button>
</h2>
<div id="flush-collapse<?=$key+1?>00" class="accordion-collapse collapse" style="height:auto!important;" data-bs-parent="#accordionFlushExampleSuffle" >
...
<button type="button" class="btn btn-primary" id="saveSuffledData">Submit</button>
</div>
</div>
</div>
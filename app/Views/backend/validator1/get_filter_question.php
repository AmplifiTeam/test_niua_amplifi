...
//print_r($uomDetail);
?>
<div class="card-body1 <?php if($allQuestiondetails['reverted']==1){ echo 'resubmitted'; }else{ echo 'submited'; } ?>  checkForChangeInStatusForRevert_<?=$allQuestiondetails['QB_ID'] ?>" parent_qb_id="<?=$allQuestiondetails['QB_ID'] ?>">
<div class="d-flex">
...
<?php }}} ?>
  <div class="remove-2  childQuestionDivOptions" parent-qb_id="<?php echo $allQuestiondetails["QB_ID"] ?>">
    ...
    <button type="button" class="btn btn-primary new-but1 approveQuestion <?=(!empty($getChildAnswer) && $getChildAnswer['validator_1_status']==1)?'bg-success':''?>" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>"><i class="bi bi-check-lg"></i>Approve</button>
<span class="nav-item dropdown pe-3">
  <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown" aria-expanded="false">
    <button type="button" class="btn btn-primary new-but1 rejectButtonClassToBeUpdated <?=(!empty($getChildAnswer) && $getChildAnswer['validator_1_status']==2)?'bg-danger':''?>" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>"><i class="bi bi-x"></i>Reject</button>
</a>
<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile" style="">
<li class="">
<a class="dropdown-item d-flex align-items-center rejectQuestion" data-value="NA" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>" href="#">
<span>NA</span>
</a>
</li>
<li class="">
<a class="dropdown-item d-flex align-items-center rejectQuestion" data-value="N/A" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>" href="#">
<span>N/A</span>
</a>
</li>
<li class="">
<a class="dropdown-item d-flex align-items-center rejectQuestion" data-value="NF" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>" href="#">
<span>NF</span>
</a>
</li>
</ul>
    ...
    <button type="button" class="btn btn-primary new-but1 openRevertWithCommentPopup <?=(!empty($getChildAnswer) && $getChildAnswer['validator_1_status']==3)?'bg-warning':''?>" qb-id="<?=(!empty($getChildAnswer) && $getChildAnswer['QB_ID']!='')?$getChildAnswer['QB_ID']:''?>"> 

...
$survey=$Survey_ID;
$redirect=base_url()."admin/city-questions2/".$cityUserId."/".$citySectorId."/".$survey;
...
<?php if($showTableCities_details['revertCity']>0){ ?>
<?php if($showTableCities_details['v2_status']!=2){ ?>
<span style="background-color: #d9fae9; color: #5aba87; border: 1px solid #5aba87; cursor: pointer;" class="dem-but4" href="javascript:void(0);" onclick="action_by_v2('<?php echo trim($showTableCities_details['id']); ?>','revert');"><a href="#">Send to city </a></span>
<?php }else{ ?>
<span style="background-color: #d9fae9; color: #5aba87; border: 1px solid #5aba87;" class="dem-but4" href="javascript:void(0);">Reverted to city official</span>	
<?php } ?>
<?php } ?>

<?php if($showTableCities_details['approveReject']==1){ ?>
<?php if($showTableCities_details['v2_status']!=1){ ?>
<span style="background-color: #d9fae9; color: #5aba87; border: 1px solid #5aba87; cursor: pointer;" class="dem-but4" href="javascript:void(0);" onclick="action_by_v2('<?php echo trim($showTableCities_details['id']); ?>','submit');"><a href="#">Submit</a></span>
<?php }else{ ?>
<span style="background-color: #d9fae9; color: #5aba87; border: 1px solid #5aba87;" class="dem-but4" href="javascript:void(0);">Submitted</span>	
<?php } ?>
<?php } ?>

<?php if($showTableCities_details['validate']==1){  ?>
<span style="background-color: #d9fae9; color: #5aba87; border: 1px solid #5aba87; cursor: pointer;" class="dem-but4" ><a href="<?=$redirect?>">Validate </a></span>
<?php } ?>
...
<tr>
<th style="font-size: smaller;font-weight: 100;" colspan="0">No data found!</th>
<th></th>
<th></th>
<th></th>
<th> </th>
